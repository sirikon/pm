...
def test_version_range_parser() -> None:
    ...
    verifyRange('3.14.1', VersionRange(
        Version(3, 14, 1), True, Version(3, 14, 1), True))
    verifyRange('3.15.20', VersionRange(
        Version(3, 15, 20), True, Version(3, 15, 20), True))

    verifyRange('~3.14.1', VersionRange(
        Version(3, 14, 1), True, Version(3, 15, 0), False))
    verifyRange('~3.0.0', VersionRange(
        Version(3, 0, 0), True, Version(3, 1, 0), False))

    verifyRange('^3.14.1', VersionRange(
        Version(3, 14, 1), True, Version(4, 0, 0), False))
    verifyRange('^0.0.0', VersionRange(
        Version(0, 0, 0), True, Version(1, 0, 0), False))
